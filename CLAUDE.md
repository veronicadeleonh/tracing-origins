...
- **Capa de rutas de navegantes (1700-1900)**: idea del usuario (16/08) — mostrar las rutas reales navegadas por potencias coloniales como capa de contexto adicional, con la misma lógica que la capa de territorios coloniales (opcional, toggle propio). Dataset candidato investigado: **CLIWOC** (Climatological Database for the World's Oceans), ~287k entradas de bitácoras de barcos holandeses/ingleses/franceses/españoles, mayormente 1750-1850, con lat/lon/fecha/capitán/origen/destino por entrada — proyecto financiado por la UE (2001-2003), digitalizado originalmente por el KNMI (instituto meteorológico holandés), reempaquetado en formatos usables por historicalclimatology.com, y espejado por la Library of Congress como parte de su colección de datasets preservados. Igual que la capa colonial, deja a EEUU/Met afuera a propósito (el dataset es específicamente de las 4 potencias navales coloniales que ya mapeamos, no una muestra neutral) — motivación explícita del usuario: "agregaría un layer importante que crea curiosidad y abre puertas a investigar más, sobretodo si vamos a tener dificultades o tomará mucho tiempo encontrar el recorrido de cada pieza en el mapa". Es una base general de bitácoras (mercantes + militares mezclados, ~89-190MB sin comprimir), no rutas de navegantes famosos ya armadas — habría que filtrar por barco/capitán/fecha (Cook, Bougainville, La Pérouse, Vancouver, etc.) para sacar las rutas específicas de interés, mismo patrón que `fetch_colonial_overlay.py` (cachear el archivo pesado sin commitear, exportar un GeoJSON chico filtrado a `web/public/`). **Licencia sin confirmar del todo todavía** — a diferencia de Cliopatria (CC-BY 4.0 explícito), no se encontró un tag de licencia formal en la búsqueda inicial; la procedencia es buena (fondos públicos de la UE, archivado por la Library of Congress) pero falta ese último chequeo antes de bajar nada. No arrancado todavía.
